...
class UpdateInfoViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun getSomethingAwesome() = viewModelScope.launch {
        try {
            val tmp = networkService.getUpdateStudentInfoPage()
            ...
            Log.d("UpdateInfoViewModel", ex.toString())
