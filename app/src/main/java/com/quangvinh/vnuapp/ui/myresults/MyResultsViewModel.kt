...
class MyResultsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun getSomethingAwesome() = viewModelScope.launch {
        try {
            val tmp = networkService.getStudentResultPage()
            ...
            Log.d("MyResultsViewModel", ex.toString())
